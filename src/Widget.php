...
abstract class Widget implements JsonSerializable
{
    ...
    public function jsonSerialize(): array
    {
        return [
            ...
            'maxWidth' => !empty($this->meta[ 'options' ][ 'maxWidth' ]) ? (int) $this->meta[ 'options' ][ 'maxWidth' ] : null,
            'maxHeight' => !empty($this->meta[ 'options' ][ 'maxHeight' ]) ? (int) $this->meta[ 'options' ][ 'maxHeight' ] : null,
            'data' => $this->meta(),
        ];
    }
